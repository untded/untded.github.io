...
for (const f of ['untded.jsonld', 'untded.ttl', 'vocabulary.json', 'edifact-links.json', 'context.jsonld']) {
...
console.log('synced elements.json, categories.json, untded.jsonld, untded.ttl, vocabulary.json, edifact-links.json, context.jsonld, rdf/, pdf/')
