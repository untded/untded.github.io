...
// Every label and bridge parse in the site derives from here — components
// never re-encode this knowledge. This module is pure: no node imports,
// so client bundles (UnlkExplorer's script via lib/unlk) can use it
// freely. Data access lives in data.ts — the single seam.
