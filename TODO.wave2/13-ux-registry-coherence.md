...
- [x] Long tables read like the ledger they are (ontology, ledger,
...
- [x] Element page print polish: verify the new sections (bridges,
      chips, UNLK card) print sanely; extend the existing print block
      minimally if needed (black-on-white, no chrome).
- [x] Contracts: zebra/sticky utility applied on /ontology /ledger
...
Shipped 2026-09-07 (website PR). Functional verification: keyboard
drive of the explorer (focus, + ×2 → 2.6×, ArrowLeft pans the viewBox,
0 resets); print emulation of /elements/1004 renders the record card
black-on-white with the new sections intact; screenshots reviewed light,
dark, and 390px mobile. 108 tests, 0 type errors, 0 link errors.
